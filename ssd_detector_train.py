        ...
        while True:
            ...
            for i, key in enumerate(keys):
                ...
                if key[:4] == 'back':
                    ...
                    inputs.append(img)
                    targets.append(y)
                    return preprocess_input(np.array(inputs)), np.array(targets)
                # inputs.append(img)
                # targets.append(y)
                # if len(targets) == self.batch_size:
                #     tmp_inp = np.array(inputs)
...
path_prefix = '/Users/Lavector/dataset/VOC2012/JPEGImages/'
gen = Generator(gt, bbox_util, 16, '/Users/Lavector/dataset/VOC2012/JPEGImages/',
                train_keys, val_keys,
